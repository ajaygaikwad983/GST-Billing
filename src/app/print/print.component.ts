	...
	content: [
		{
			...
			table: {
				...
				body: [
					[{image: environment.logo, width: 180, alignment: 'center', margin: [10,10,10,10]},{type: 'none', style: 'bold', margin: [20,22,30,10], ol: ['Address of the company','City','Tel. : 1234567890, 0123456789','E-mail : test@gmail.com']}],
            		    ...
            		    table: {
            		        ...
            		        body: [
            		            [{text: [
            		                    ...
            		                    ], bold: true, margin: [5,5,5,5], border: [false,false,true,false], fontSize: 10},{text: 'GSTN ************', fontSize: 13, alignment: 'center', bold: true, margin: [10,20,20,20], border: [true,false,true,false]},{image: environment.img, width: 90, margin: [70,30,0,0], border: [true,false,false,false]}],
            		            ]
            		    },
            		    colSpan: 2
            		},'']
